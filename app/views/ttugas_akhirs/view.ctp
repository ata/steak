...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Tugas Akhir', true), array('action'=>'edit', $ttugasAkhir['TtugasAkhir']['NIM'])); ?> </li>
		<li><?php echo $html->link(__('Hapus tugas Akhir', true), array('action'=>'delete', $ttugasAkhir['TtugasAkhir']['NIM']), null, sprintf(__('Are you sure you want to delete # %s?', true), $ttugasAkhir['TtugasAkhir']['NIM'])); ?> </li>
