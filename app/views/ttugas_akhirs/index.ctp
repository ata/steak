...
<table class="filter">
	<tr>
		<td>
			<?php echo $form->input('NIM', array('label'=>'Masukan NIM', 'div'=>'filter', 'fieldset'=>false))?>
		</td>
...
?>
	<tr<?php echo $class;?>>
		<td>
			<?php echo $ttugasAkhir['TtugasAkhir']['NIM']; ?>
		</td>
		...
		<td class="actions">
				<?php echo $html->link($html->image('Download.gif'), array('action'=>'downloadfile', $ttugasAkhir['TtugasAkhir']['NIM']), array('title'=>'download file'),false,false); ?>
				<?php echo $html->link($html->image('page_16.png'), array('action'=>'view', $ttugasAkhir['TtugasAkhir']['NIM']), array('title'=>'Lihat data lengkap'),false,false); ?>
				<?php echo $html->link($html->image('pencil_16.png'), array('action'=>'edit', $ttugasAkhir['TtugasAkhir']['NIM']), array('title'=>'edit'),false,false); ?>
				<?php echo $html->link($html->image('del_16.png'), array('action'=>'delete', $ttugasAkhir['TtugasAkhir']['NIM']), array('title'=>'hapus'), sprintf(__('Are you sure you want to delete # %s?', true), $ttugasAkhir['TtugasAkhir']['NIM']),false); ?>
		</td>
	</tr>
<?php endforeach; ?>
</tbody>
