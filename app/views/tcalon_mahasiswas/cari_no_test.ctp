	...
	if(isset($payments)){		
		...
		<?php echo $form->create('T2calonMahasiswa',array('url'=>'/tmahasiswas/add','class'=>'plain', "type"=>"file"));?>
			...
			<fieldset>
				...
				echo $form->radio('ambil_jurusan',array($row['TcalonMahasiswa']['TPROGRAM_ID'] ."-".$row['TcalonMahasiswa']['TJURUSAN_ID']=>$row['Tprogram']['value'] ."-".$row['Tjurusan']['namaJurusan'],$row['TcalonMahasiswa']['TPROGRAM_ID2'] ."-".$row['TcalonMahasiswa']['TJURUSAN_ID2']=>$row['Tprogram2']['value'] ."-".$row['Tjurusan2']['namaJurusan']));
				//echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				
				//echo $form->input('ambil_jurusan',array("type"=>"radiobutton", "value"=>$row['Tprogram2']['value'] ."-".$row['Tjurusan2']['namaJurusan']));
				echo "<br>";
				echo "</p>";
