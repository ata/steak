...
<div class="tmahasiswas view grid_12 alpha " id="content">
	<div class="box">
		<h2 class="section_name"><span class="section_name_span"><?php __('Data Lengkap Calon Mahasiswa baru');?></span></h2>
	...
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Kota Asal : '); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tmahasiswa['Tmahasiswa']['KOTA_ASAL']; ?>
			&nbsp;
		</dd>
		<br>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Ubah Calon Mahasiswa', true), array('action'=>'edit', $tmahasiswa['Tmahasiswa']['NO_TEST'])); ?> </li>
		<li><?php echo $html->link(__('Hapus Calon Mahasiswa', true), array('action'=>'delete', $tmahasiswa['Tmahasiswa']['NO_TEST']), null, sprintf(__('Are you sure you want to delete # %s?', true), $tmahasiswa['Tmahasiswa']['NO_TEST'])); ?> </li>
