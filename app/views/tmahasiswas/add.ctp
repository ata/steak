<div class="tmahasiswas form grid_16" id="content" >
	<div class="box">
		...
		<h2 class="section_name"><span class="section_name_span"><?php __('Input Mahasiswa ');?></span></h2>
		<?php echo $form->create('T2calonMahasiswa',array('url'=>'/tmahasiswas/add','class'=>'plain', "type"=>"file"));?>
			...
			<hr class="separator" />
			<fieldset>Perguruan Tinggi Asal
			<?php
				echo "<br>";
				echo $form->input('UNIV_ASAL', array('label'=>'Universitas Asal'));
