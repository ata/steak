			...
			<tbody>
				...
				<tr>
					...
					<td class="actions">
						...
						<?php echo $html->link($html->image('ubahxxx.gif'), array('action'=>'edit_nilai', $tmahasiswa['Tmahasiswa']['NIM']), array('title'=>'Ubah Nilai Test'),false,false); ?>
						<?php 
							//echo $form->input('status',array('type'=>'select','options'=>array('0'=>'Tidak Diterima','1'=>'Diterima'),'label'=>FALSE));
						?>
