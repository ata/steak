...
<tbody>
	<tr>
		...
		<td class="actions">
				<?php echo $html->link($html->image('Download.gif'), array('action'=>'downloadfile', $tkerjapraktek['Tkerjapraktek']['NIM']), array('title'=>'download file'),false,false); ?>
				<?php echo $html->link($html->image('page_16.png'), array('action'=>'view', $tkerjapraktek['Tkerjapraktek']['NIM']), array('title'=>'Lihat data lengkap'),false,false); ?>
				<?php echo $html->link($html->image('pencil_16.png'), array('action'=>'edit', $tkerjapraktek['Tkerjapraktek']['NIM']), array('title'=>'edit'),false,false); ?>
				<?php echo $html->link($html->image('del_16.png'), array('action'=>'delete', $tkerjapraktek['Tkerjapraktek']['NIM']), array('title'=>'hapus'), sprintf(__('Are you sure you want to delete # %s?', true), $tkerjapraktek['Tkerjapraktek']['NIM']),false); ?>
		</td>
