...
<div class="frs index grid_12 alpha " id="content">
 ...
 $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php if(!empty($tmahasiswa['TstatusPembayaran'][0]))
			echo $tmahasiswa['TstatusPembayaran'][0]['keterangan'];
			else
			echo "<span class='negatif'>Belum ada Pembayaran</span>"; ?>
			&nbsp;
		</dd>
...
<?php
//pr($kartuStudis);
if(empty($kartuStudis) && !empty($tmahasiswa['TstatusPembayaran']))
